...
const Catalog = () => {
  const products: Product[] = [
    ...
    { id: 2, name: 'iPhone 12', brand: 'Apple', image: 'https://images.unsplash.com/photo-1556656793-08538906a9f8?w=800&h=1000&fit=crop', images: ['https://images.unsplash.com/photo-1556656793-08538906a9f8?w=800&h=1000&fit=crop', 'https://images.unsplash.com/photo-1556656793-08538906a9f8?w=800&h=1000&fit=crop', 'https://images.unsplash.com/photo-1556656793-08538906a9f8?w=800&h=1000&fit=crop'], images: ['https://images.unsplash.com/photo-1556656793-08538906a9f8?w=800&h=1000&fit=crop', 'https://images.unsplash.com/photo-1585060544812-6b45742d762f?w=800&h=1000&fit=crop', 'https://images.unsplash.com/photo-1580910051074-3eb694886505?w=800&h=1000&fit=crop'], price: 0, info: 'Funda slim con soporte MagSafe.', colors: [{ name: 'Negro', hex: '#1a1a1a' }, { name: 'Azul', hex: '#1e3a5f' }, { name: 'Verde', hex: '#4a7c59' }] },
    { id: 3, name: 'iPhone 13', brand: 'Apple', image: 'https://images.unsplash.com/photo-1603891219031-7c0e9f5e5e15?w=800&h=1000&fit=crop', images: ['https://images.unsplash.com/photo-1603891219031-7c0e9f5e5e15?w=800&h=1000&fit=crop', 'https://images.unsplash.com/photo-1603891219031-7c0e9f5e5e15?w=800&h=1000&fit=crop', 'https://images.unsplash.com/photo-1603891219031-7c0e9f5e5e15?w=800&h=1000&fit=crop'], images: ['https://images.unsplash.com/photo-1603891219031-7c0e9f5e5e15?w=800&h=1000&fit=crop', 'https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?w=800&h=1000&fit=crop', 'https://images.unsplash.com/photo-1556656793-08538906a9f8?w=800&h=1000&fit=crop'], price: 0, info: 'Carcasa de silicona premium resistente.', colors: [{ name: 'Negro', hex: '#000000' }, { name: 'Rosa', hex: '#ffc0cb' }, { name: 'Azul Claro', hex: '#87ceeb' }] },
